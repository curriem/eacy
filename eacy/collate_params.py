...
def collate(telescope_name, instrument_name, detector_name, output_format, save=False):
...
if __name__ == "__main__":
    ...
    params_all = collate(telescope_name, instrument_name, detector_name, output_format, save=True)